...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_301_346} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/371b/c4d7/c13c39a8e42caa9439840c56f42749c4"
        }}
        style={styles.ImageBackground_301_347}
      />
      <View style={styles.View_301_348}>
        <View style={styles.View_I301_348_301_10}>
          <View style={styles.View_I301_348_301_11} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/829b/7bad/33d4cb76ec1c716994f7048664a38f99"
            }}
            style={styles.ImageBackground_I301_348_301_12}
          />
          <View style={styles.View_I301_348_301_13} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_348_301_14}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_348_301_18}
        />
        <View style={styles.View_I301_348_301_23}>
          <View style={styles.View_I301_348_301_24}>
            <Text style={styles.Text_I301_348_301_24}>9:41</Text>
          </View>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I301_348_301_12: {
  ...
  ImageBackground_I301_348_301_14: {
    flexGrow: 1,
  ...
  ImageBackground_I301_348_301_18: {
    flexGrow: 1,
