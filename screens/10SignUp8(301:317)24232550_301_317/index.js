...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_301_318}>
        <View style={styles.View_I301_318_301_10}>
          <View style={styles.View_I301_318_301_11} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/24cb/6ae5/37bf546194989d63627a392d13125a38"
            }}
            style={styles.ImageBackground_I301_318_301_12}
          />
          <View style={styles.View_I301_318_301_13} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_318_301_14}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_318_301_18}
        />
        <View style={styles.View_I301_318_301_23}>
          <View style={styles.View_I301_318_301_24}>
            <Text style={styles.Text_I301_318_301_24}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_301_319}>
        <Text style={styles.Text_301_319}>Confirmed!</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_301_320}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_301_321}
      />
    </ScrollView>
  )
}
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I301_318_301_12: {
  ...
  ImageBackground_I301_318_301_14: {
    flexGrow: 1,
  ...
  ImageBackground_I301_318_301_18: {
    flexGrow: 1,
  ...
  View_I301_318_301_23: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("5.600001385822388%"),
    top: hp("1.055207799692623%"),
    backgroundColor: "rgba(0, 0, 0, 0)"
  },
  View_I301_318_301_24: {
  ...
  ImageBackground_301_320: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("38.9333236620622%")
  },
  ImageBackground_301_321: {
