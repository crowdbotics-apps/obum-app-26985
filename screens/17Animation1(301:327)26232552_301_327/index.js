...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_301_328}>
        <View style={styles.View_I301_328_301_10}>
          <View style={styles.View_I301_328_301_11} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/24cb/6ae5/37bf546194989d63627a392d13125a38"
            }}
            style={styles.ImageBackground_I301_328_301_12}
          />
          <View style={styles.View_I301_328_301_13} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_328_301_14}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_328_301_18}
        />
        <View style={styles.View_I301_328_301_23}>
          <View style={styles.View_I301_328_301_24}>
            <Text style={styles.Text_I301_328_301_24}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_301_329}>
        <Text style={styles.Text_301_329}>Yes, all set! </Text>
      </View>
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/acc4/a0bf/b4d25fdb6e120b73c0f0c15cd9581231"
        }}
        style={styles.ImageBackground_301_330}
      />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/de13/6bc4/b6d0c83470f6e6462e0d64bf08cb1302"
        }}
        style={styles.ImageBackground_301_331}
      />
    </ScrollView>
  )
}
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I301_328_301_12: {
  ...
  ImageBackground_I301_328_301_14: {
    flexGrow: 1,
  ...
  ImageBackground_I301_328_301_18: {
    flexGrow: 1,
