...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_301_314}>
        <View style={styles.View_I301_314_301_10}>
          <View style={styles.View_I301_314_301_11} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/24cb/6ae5/37bf546194989d63627a392d13125a38"
            }}
            style={styles.ImageBackground_I301_314_301_12}
          />
          <View style={styles.View_I301_314_301_13} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_314_301_14}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I301_314_301_18}
        />
        <View style={styles.View_I301_314_301_23}>
          <View style={styles.View_I301_314_301_24}>
            <Text style={styles.Text_I301_314_301_24}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_301_315}>
        <Text style={styles.Text_301_315}>
          Thanks! Give us a few seconds...
        </Text>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_301_316}
      />
    </ScrollView>
  )
}
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I301_314_301_12: {
  ...
  ImageBackground_I301_314_301_14: {
    flexGrow: 1,
  ...
  ImageBackground_I301_314_301_18: {
    flexGrow: 1,
